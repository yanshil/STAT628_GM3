...
cv.glm(data=sub_2,glmfit=m1,K=10)$delta
cv.glm(data=sub_2,glmfit=m2,K=10)$delta
cv.glm(data=sub_2,glmfit=m3,K=10)$delta
cv.glm(data=sub_2,glmfit=m4,K=10)$delta
