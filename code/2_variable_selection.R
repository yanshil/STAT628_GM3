...
summary(base.BIC)
library(boot)
m1<-glm(BODYFAT ~ AGE + ADIPOSITY + NECK + CHEST + ABDOMEN + HIP + FOREARM + WRIST, data = sub_2)
m2<-glm(BODYFAT ~ AGE + ADIPOSITY + CHEST + ABDOMEN + WRIST,data = sub_2)
m3<-glm(BODYFAT ~ ABDOMEN + WEIGHT + WRIST + BICEPS + AGE, data = sub_2)
m4<-glm(BODYFAT ~ ABDOMEN + WEIGHT + WRIST, data = sub_2)
