...
summary(base.BIC)
library(boot)
m1<-glm(BODYFAT ~ AGE + ADIPOSITY + NECK + CHEST + ABDOMEN + HIP + FOREARM + WRIST, data = dat)
m2<-glm(BODYFAT ~ AGE + ADIPOSITY + CHEST + ABDOMEN + WRIST,data = dat)
m3<-glm(BODYFAT ~ ABDOMEN + WEIGHT + WRIST + BICEPS + AGE, data = dat)
m4<-glm(BODYFAT ~ ABDOMEN + WEIGHT + WRIST, data = dat)
